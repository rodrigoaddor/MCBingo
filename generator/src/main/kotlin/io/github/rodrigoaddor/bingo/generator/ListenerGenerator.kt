...
@SupportedAnnotationTypes("io.github.rodrigoaddor.bingo.generator.RegisterListener")
@SupportedSourceVersion(SourceVersion.RELEASE_8)
@SupportedOptions(ListenerGenerator.KAPT_KOTLIN_GENERATED)
class ListenerGenerator : AbstractProcessor() {
    ...
    override fun getSupportedAnnotationTypes(): MutableSet<String> {
        return mutableSetOf(RegisterListener::class.java.name)
    }
    ...
    override fun process(annotations: MutableSet<out TypeElement>, roundEnv: RoundEnvironment): Boolean {
        ...
        val targetType = processingEnv.elementUtils.getTypeElement(RegisterListener::class.java.canonicalName).asType()
        ...
        val elements = roundEnv.getElementsAnnotatedWith(RegisterListener::class.java)
        ...
        val registerCode = CodeBlock
            .builder()
            .addStatement(
                "val pm = %T.getPluginManager()",
                ClassName("org.bukkit", "Bukkit")
            )
        ...
        val objSpec = TypeSpec
            .objectBuilder("RegisterListeners")
            .addFunction(
                FunSpec
                    .builder("invoke")
                    .addModifiers(KModifier.OPERATOR)
                    .addParameter("plugin", ClassName("org.bukkit.plugin", "Plugin"))
